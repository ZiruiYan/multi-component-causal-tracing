...
from utils.utils_mlp import evaluate
...
parser.add_argument("--model", type=str, help = 'model type', default='gpt2', choices=['distilgpt2', 'gpt2', 'gpt2-medium', 'gpt2-large', 'gpt2-xl', "EleutherAI/gpt-j-6B"])
...
# Xavier or Kaiming Initialization (adapted for [0, 1])
# z = torch.empty((12, 768), device=device).uniform_(-1, 1)  # Xavier range
